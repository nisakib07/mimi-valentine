...
# Replace noMessages
$content = $content -replace "const noMessages = \[[\s\S]*?\];", $noMessagesNew

# Replace yesMessages
$content = $content -replace "const yesMessages = \[[\s\S]*?\];", $yesMessagesNew

# Replace topEmojis
$content = $content -replace "const topEmojis = \[[\s\S]*?\];", $topEmojisNew

$content | Set-Content -Path "script.js" -Encoding UTF8
